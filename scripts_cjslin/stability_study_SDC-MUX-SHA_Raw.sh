...
for j in 1p20; do
	...
	./plotRamp_2MSamples_Raw.py Sinusoid_20KHz_SE-FrozenSHA_NomVREFPN_2M_v${i}.txt
...
for j in 1p20; do
	...
	./plotRamp_2MSamples_Raw.py Sinusoid_20KHz_SE-SHA_NomVREFPN_2M_v${i}.txt
...
for j in 1p20; do
	...
	./plotRamp_2MSamples_Raw.py Sinusoid_20KHz_SDC-FrozenSHA_NomVREFPN_2M_v${i}.txt
...
for j in 1p20; do
	...
	./plotRamp_2MSamples_Raw.py Sinusoid_20KHz_SDC-SHA_NomVREFPN_2M_v${i}.txt
	echo "Iteration #${i} completed"
    done
done
