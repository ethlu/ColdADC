...
def main(fileName):
    ...
    plt.hist(stage0Hist[0][:],log=True,bins=19, align='mid')    
    
    ax2 = fig0.add_subplot(2,2,2)
    plt.title('Stage 0')
    plt.gcf().text(0.60,0.8,"S1")
    plt.hist(stage0Hist[1][:],log=True,bins=19, align='mid')

    ax3 = fig0.add_subplot(2,2,3)
    plt.xlabel('ADC Channel')
    plt.gcf().text(0.20,0.4,"S2")
    plt.ylabel('Counts')
    plt.hist(stage0Hist[2][:],log=True,bins=19, align='mid')    

    ax4 = fig0.add_subplot(2,2,4)
    plt.xlabel('ADC Channel')
    plt.gcf().text(0.60,0.4,"S3")
    plt.hist(stage0Hist[3][:],log=True,bins=19, align='mid')    
    ...
    plt.title('Stage 1')
    plt.gcf().text(0.20,0.8,"S0")
    plt.hist(stage1Hist[0][:],log=True,bins=13, align='mid')    
    
    ax2 = fig1.add_subplot(2,2,2)
    plt.title('Stage 1')
    plt.gcf().text(0.60,0.8,"S1")
    plt.hist(stage1Hist[1][:],log=True,bins=13, align='mid')

    ax3 = fig1.add_subplot(2,2,3)
    plt.xlabel('ADC Channel')
    plt.gcf().text(0.20,0.4,"S2")
    plt.ylabel('Counts')
    plt.hist(stage1Hist[2][:],log=True,bins=13, align='mid')    

    ax4 = fig1.add_subplot(2,2,4)
    plt.xlabel('ADC Channel')
    plt.gcf().text(0.60,0.4,"S3")
    plt.hist(stage1Hist[3][:],log=True,bins=13, align='mid')    
    ...
    plt.title('Stage 2')
    plt.gcf().text(0.20,0.8,"S0")
    plt.hist(stage2Hist[0][:],log=True,bins=9, align='mid')    
    
    ax2 = fig2.add_subplot(2,2,2)
    plt.title('Stage 2')
    plt.gcf().text(0.60,0.8,"S1")
    plt.hist(stage2Hist[1][:],log=True,bins=9, align='mid')

    ax3 = fig2.add_subplot(2,2,3)
    plt.xlabel('ADC Channel')
    plt.gcf().text(0.20,0.4,"S2")
    plt.ylabel('Counts')
    plt.hist(stage2Hist[2][:],log=True,bins=9, align='mid')    

    ax4 = fig2.add_subplot(2,2,4)
    plt.xlabel('ADC Channel')
    plt.gcf().text(0.60,0.4,"S3")
    plt.hist(stage2Hist[3][:],log=True,bins=9, align='mid')    
    ...
    plt.title('Stage 3')
    plt.gcf().text(0.20,0.8,"S0")
    plt.hist(stage3Hist[0][:],log=True,bins=5, align='mid')    
    
    ax2 = fig3.add_subplot(2,2,2)
    plt.title('Stage 3')
    plt.gcf().text(0.60,0.8,"S1")
    plt.hist(stage3Hist[1][:],log=True,bins=5, align='mid')

    ax3 = fig3.add_subplot(2,2,3)
    plt.xlabel('ADC Channel')
    plt.gcf().text(0.20,0.4,"S2")
    plt.ylabel('Counts')
    plt.hist(stage3Hist[2][:],log=True,bins=5, align='mid')    

    ax4 = fig3.add_subplot(2,2,4)
    plt.xlabel('ADC Channel')
    plt.gcf().text(0.60,0.4,"S3")
    plt.hist(stage3Hist[3][:],log=True,bins=5, align='mid')    
    ...
    plt.title('Stage 4')
    plt.gcf().text(0.20,0.8,"S0")
    plt.hist(stage4Hist[0][:],log=True,bins=3, align='mid')    
    
    ax2 = fig4.add_subplot(2,2,2)
    plt.title('Stage 4')
    plt.gcf().text(0.60,0.8,"S1")
    plt.hist(stage4Hist[1][:],log=True,bins=3, align='mid')

    ax3 = fig4.add_subplot(2,2,3)
    plt.xlabel('ADC Channel')
    plt.gcf().text(0.20,0.4,"S2")
    plt.ylabel('Counts')
    plt.hist(stage4Hist[2][:],log=True,bins=3, align='mid')    

    ax4 = fig4.add_subplot(2,2,4)
    plt.xlabel('ADC Channel')
    plt.gcf().text(0.60,0.4,"S3")
    plt.hist(stage4Hist[3][:],log=True,bins=3, align='mid')    
    ...
    plt.title('Stage 5')
    plt.gcf().text(0.20,0.8,"S0")
    plt.hist(stage5Hist[0][:],log=True,bins=2, align='mid')    
    
    ax2 = fig5.add_subplot(2,2,2)
    plt.title('Stage 5')
    plt.gcf().text(0.60,0.8,"S1")
    plt.hist(stage5Hist[1][:],log=True,bins=2, align='mid')

    ax3 = fig5.add_subplot(2,2,3)
    plt.xlabel('ADC Channel')
    plt.gcf().text(0.20,0.4,"S2")
    plt.ylabel('Counts')
    plt.hist(stage5Hist[2][:],log=True,bins=2, align='mid')    

    ax4 = fig5.add_subplot(2,2,4)
    plt.xlabel('ADC Channel')
    plt.gcf().text(0.60,0.4,"S3")
    plt.hist(stage5Hist[3][:],log=True,bins=2, align='mid')    
    ...
    plt.title('Stage 6')
    plt.gcf().text(0.20,0.8,"S0")
    plt.hist(stage6Hist[0][:],log=True,bins=2, align='mid')    
    
    ax2 = fig6.add_subplot(2,2,2)
    plt.title('Stage 6')
    plt.gcf().text(0.60,0.8,"S1")
    plt.hist(stage6Hist[1][:],log=True,bins=2, align='mid')

    ax3 = fig6.add_subplot(2,2,3)
    plt.xlabel('ADC Channel')
    plt.gcf().text(0.20,0.4,"S2")
    plt.ylabel('Counts')
    plt.hist(stage6Hist[2][:],log=True,bins=2, align='mid')    

    ax4 = fig6.add_subplot(2,2,4)
    plt.xlabel('ADC Channel')
    plt.gcf().text(0.60,0.4,"S3")
    plt.hist(stage6Hist[3][:],log=True,bins=2, align='mid')    
